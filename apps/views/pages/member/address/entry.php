<h3 class="content_edit">Member Control Panel  Create Address List</h2>
...
<?php echo form_open("org_member/letter/added_address"); ?>
        ...
        <table width="900" cellspacing="1" align="center" cellpadding="2" border="0" id="theBody" style="margin-left:40px; margin-top:10px">
            <tbody>
                <tr>
                    ...
                    <td width="45%">
                     <input name="address_title" style="width:200px; height:30px" class="" type="text">
