<h3 class="content_edit">Member Control Panel  View Archive letter</h2>
<style>
    .SearchListing{
...
<?php
$r = $this->db->query("select * from letter_archive where org_id='".$this->session->userdata('member_org')."'order by id desc");
