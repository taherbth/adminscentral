<h3 class="content_edit">Member control panel Reply Message
</h2>
<style>
...
<div class="infobox" style="width: 550px; margin-bottom: 20px; font-size: 12px; -moz-border-radius: 8px 8px 8px 8px;">
    ...
    <?php echo form_open_multipart("org_member/letter/message_replied"); ?>
    <?php echo $this->session->flashdata('message'); ?>
    <input type="hidden" name="id" value="<?php echo $m_info->id;?>" />

     Send To<br>
    <input name="name" class="form_normal" readonly="readonly" value="Orgadmin" type="text">
    <br>
