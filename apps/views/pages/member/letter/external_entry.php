<h3 class="content_edit">Member Control Panel  Send Letter To External Users</h2>
...
<?php echo form_open("org_member/letter/added_external_letter"); ?>
...
<div class="infobox" style="width: 916px; margin-bottom: 20px; font-size: 12px; -moz-border-radius: 8px 8px 8px 8px;">
    <div class="infobox_left" style="width: 900px;">
        ...
        <div style="width:800px; float:left; margin-left:120px">
            ...
            <ul>
                <?php $q = $this->db->query("select * from address_list where org_id='".$this->session->userdata('member_org')."'and member_id='".$this->session->userdata('id')."'"); ?>
                <?php foreach ($q->result() as $p): ?>
                    <li style="width:350px; float:left; position:relative">
                        <span style="width:320px; float:left; position:relative; left:7px"> <?php echo $p->address_title; ?>  ,<?php echo $p->address; ?></span>
