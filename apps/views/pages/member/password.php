<h3 class="content_edit">Member Control Panel Change Password</h2>
<style>
...
<?php echo form_open("org_member/info/changed_password"); ?>
...
<div class="infobox" style="width: 916px; margin-bottom: 20px; font-size: 12px; -moz-border-radius: 8px 8px 8px 8px;">
    ...
    <table width="662" cellspacing="1" align="center" cellpadding="2" border="0" id="theBody">
        <tbody>
            ...
            <tr>
                <td width="30%" style=" text-align:left;padding-left:45px"><font class="inside">Old Password:</font></td>
                <td width="33%">
            ...
            <span class="markcolor"><?php echo ucwords(form_error('old_password')); ?></span>
               ...
               <tr>
                <td width="30%" style="text-align:right; padding-top:5px"></td>
                <td width="33%">
                </td>

            </tr>
            <tr>
                <td width="30%" style=" text-align:left;padding-left:45px"><font class="inside">New Password:</font></td>
                <td width="33%">
