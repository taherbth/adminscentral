...
<?php
$query = $this->db->query("select * from member_post where org_id ='" . $this->session->userdata('member_org') . "' and id='" . $id . "'");
...
-->        <p style="font-size:12px; color:#0077D6;padding-left:40px;"><?php echo $p->text; ?></p>
        <p style="font-size:12px;padding-left:40px; ;">
            ...
            <b>Creation Date:</b><?php echo $p->date_of_creation; ?>&nbsp; <?php echo $p->creation_time; ?>&nbsp;&nbsp;
        ...
        <p>
            <?php echo form_open("org_member/info/add_article_comment"); ?>
            <input type="hidden"   name="article_post_id" value="<?php echo $p->id; ?>" > 
            <textarea rows="5" name="article_comment" class="forum_comment1" cols="35" onfocus="clearText(this);">Write Your Comment here...</textarea><br />
