<h3 class="content_edit">Member Control Panel  Send Sms to External Member</h2>
<style>
    input {
...
<?php echo form_open("org_member/sms/added_external_sms"); ?>
...
<div class="infobox" style="width: 916px; margin-bottom: 20px; font-size: 12px; -moz-border-radius: 8px 8px 8px 8px;">
    <div class="infobox_left" style="width: 900px;">
        ...
        <div style="width:800px; float:left; margin-left:120px">
            ...
            <ul>
                <?php $q = $this->db->query("select * from contact_list where org_id='" . $this->session->userdata('member_org') . "'and member_id='".$this->session->userdata('id')."'"); ?>
