...
<script>
    ...
    <?php
    $query = $this->db->query("select * from forum where org_id ='" . $this->session->userdata('user_id') . "' and id='".$id."'");
               ...
               <p  style="padding-left:10px;  font-size:16px; font-weight:bold"><h2 id="r" style="padding-left:40px; padding-top:10px; height:40px;color:#0077D6; font-weight:bold"><?php echo $p->title; ?></h2></p>
                ...
                foreach ($s->result() as $c_info):
                   ...
                   <p class="forum_comment"  ><b style="color:#008048">
                        ...
                        &nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;
                        <a onclick="return confirmSubmit()" href="<?php echo base_url(); ?>organization/info/delete_forum_post/<?php echo $c_info->id; ?>/<?php echo $p->id; ?>">Delete</a>
                    <a  href="<?php echo base_url(); ?>organization/info/archive_forum_comments/<?php echo $c_info->id; ?>/<?php echo $p->id; ?>">Archive</a>     
