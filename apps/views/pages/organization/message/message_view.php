...
<?php if(count($message_info->sender_id)):
...
<?php echo ucfirst($message_info->name); ?> 
                                  ...
                                  <?php if(isset($member_id)) :?> 
                                     <tr >
                                        <td style="width:100px" valign="top" style="padding-top: 12px; font-weight:bold"><b>Member Id :</b></td>
                                        <td>
<?php echo $member_id; ?> 
                                        </td>
                                    </tr>
...
<?php echo ucfirst($g_name); ?> 
                                   ...
                                   <?php if($message_info->email !="") :?> 
                                     <tr>
                                        <td valign="top" style="padding-top: 12px; font-weight:bold">Email:</td>
                                        <td>
                                    ...
                                    <tr>
                                       ...
                                       <?php endif; ?>
                                        <?php if ($message_info->sender_status == "1"): ?>
                                          
                                          Click here to <a   href="<?php echo base_url(); ?>organization/info/reply_message/<?php echo $message_info->id;?>"><font color="green">Reply</font> </a>
                                        <?php endif;?>
                                        </td>
                                    </tr>
                                    <tr>
