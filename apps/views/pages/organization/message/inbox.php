...
<style>
  ...
  All:<input type="checkbox" onClick="checkAll(this)">
   <?php echo form_open("organization/info/delete_message"); ?>
    ...
    <div class="SearchListing1"  style=" background-color:#F5F5F5; border:1px solid #E5E5E5; height:30px; width:900px">
     ...
     <span style="width:100px; float:left; position:relative; text-align:left"> <?php echo $message_info->name;?></span>
     <a href="<?php echo base_url(); ?>organization/info/view_message/<?php echo $message_info->id;?>">
