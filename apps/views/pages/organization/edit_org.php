...
<?php echo form_open_multipart("organization/info/edit_org"); ?>
    ...
    <table width="662" cellspacing="1" align="center" cellpadding="2" border="0" id="theBody">
        <tbody>
            ...
            <tr>
                ...
                <td width="33%"><input  type="text"  size="30" maxlength="20" value="<?php echo $p_info->org_name ;?>" name="org_name" tabindex="2">
...
-->                    <span class="markcolor"><?php echo ucwords(form_error('person_number')); ?></span>
            ...
            <tr>
             ...
             <tr>
                <td width="18%" style="vertical-align:middle"><font class="inside">Bank Info:</font></td>
                <td width="33%">
              <textarea rows="3" style="background: none repeat scroll 0 0 #CCCCCC;" name="bank_info"  tabindex="6" value="" cols="20"><?php echo $p_info->bank_info ;?></textarea>
                ...
                <td width="33%">
                    ...
                    <select name="org_type" id="org_type" style="width:300px" tabindex="18" onchange="check_value(this.value)">
                        ...
                        <?php foreach ($query1->result() as $info1): ?>
                          <!--  <option value="<?php // echo $info1->id; ?>"><?php //echo $info1->org_type; ?></option>-->
