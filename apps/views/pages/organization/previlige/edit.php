<h3 class="content_edit">Org Admin Control Panel Modify Internal Users Previlization Setting </h2>
...
if ($query1->num_rows() == 0) {
    ...
    endforeach;
    $query12 = $this->db->query("select * from member_previlige where user_type ='" . $usertype . "'");
//echo "<pre>";print_r($query12->result());
    foreach ($query12->result() as $info):
    endforeach;
    ?>
    <?php echo form_open("organization/info/update_previlize"); ?>
    ...
    <div class="infobox" style="width: 916px; margin-bottom: 20px; font-size: 12px; -moz-border-radius: 8px 8px 8px 8px;">
        <div class="infobox_left" style="width: 900px;">
          <?php  $u = $this->db->query("select user_type from user_type where id ='" . $usertype . "'");
		       foreach($u->result() as $t):
			   $utype_name=$t->user_type;
			   endforeach;?>
            ...
            <table width="900" cellspacing="1" align="center" cellpadding="2" border="0" id="theBody" style="margin-left:40px; margin-top:10px">
                <tbody>
                    <tr>
                        ...
                        <td width="45%">
                     <input type="text" readonly="readonly" value="<?php echo $utype_name; ?>" />                        </td>
        ...
        <div class="infobox_right" style="width: 900px;">
            <div style="width:420px; float:left; position:relative; ">
                        ...
                        <?php if ($previlize_info->mainboard_manually_archive == '1'): ?> 
                            <tr>
                                ...
                                <td width="33%">
                                    ...
                                    <input  type="checkbox" name="mainboard_manually_archive"  checked="checked" value="1" />
                                    <?php else: ?>
                ...
                <table width="336" border="0" align="center" cellpadding="2" cellspacing="1" id="theBody" style="margin-left:40px">
<tbody>
                        <tr>
                            <td width="65%"><font class="inside" style="font-weight:bold; color:green">Forum</font></td>
                          <td width="35%">                            </td>
          </tr>
                        <?php if ($previlize_info->forum_access == '1'): ?> 
                            <tr>
                                <td width="65%"><font class="inside">Access the forum </font></td>
                          <td width="35%">
                                    <?php if ($info->forum_access == '1'): ?>
<input type="checkbox" name="forum_access" value="1" checked="checked" />
                                    <?php else: ?>
                        ...
                        <?php if ($previlize_info->forum_comments == '1'): ?> 
                            <tr>
                                <td width="65%"><font class="inside">Make comments</font></td>
                          <td width="35%">
                                    <?php if ($info->forum_comments == '1'): ?>
<input type="checkbox" name="forum_comments" value="1" checked="checked" />
                                    <?php else: ?>
                        ...
                        <?php if ($previlize_info->forum_delete_won_comments == '1'): ?> 
                            <tr>
                                <td width="65%"><font class="inside">Delete ones owns comments</font></td>
                          <td width="35%">
                                    <?php if ($info->forum_delete_won_comments == '1'): ?>
<input type="checkbox" name="forum_delete_won_comments" value="1" checked="checked" />
                                    <?php else: ?>
                        ...
                        <?php if ($previlize_info->forum_delete_any_coments == '1'): ?> 
                            <tr>
                                <td width="65%"><font class="inside">Delete any comments</font></td>
                          <td width="35%">
                                    <?php if ($info->forum_delete_any_coments == '1'): ?>
<input type="checkbox" name="forum_delete_any_coments" value="1" checked="checked" />
                                    <?php else: ?>
                        ...
                        <?php if ($previlize_info->forum_manual_comments == '1'): ?> 
                            <tr>
                                <td width="65%"><font class="inside">manually archive comments</font></td>
                          <td width="35%">
                                    <?php if ($info->forum_manual_comments == '1'): ?>
<input type="checkbox" name="forum_manual_comments" value="1" checked="checked" />
                                    <?php else: ?>
...
<table width="263" border="0" align="center" cellpadding="2" cellspacing="1" id="theBody" style="margin-left:40px">
<tbody>
                        <tr>
                            <td width="57%"><font class="inside" style="font-weight:bold; color:green">Members own account
                                </font></td>
                          <td width="43%">                            </td>
          </tr>
                        <?php if ($previlize_info->member_login_logout == '1'): ?> 
                            <tr>
                                <td width="57%"><font class="inside">Log in/Log out </font></td>
                          <td width="43%" style="padding-left:70px">
                                    <?php if ($info->member_login_logout == '1'): ?>
<input type="checkbox" name="member_login_logout" value="1" checked="checked"/>
                                    <?php else: ?>
                        ...
                        <?php if ($previlize_info->member_change_profile == '1'): ?> 
                            <tr>
                                <td width="57%"><font class="inside">Add/change profile info</font></td>
                          <td width="43%" style="padding-left:70px">
                                    <?php if ($info->member_change_profile == '1'): ?>
<input type="checkbox" name="member_change_profile" value="1" checked="checked" />
                                    <?php else: ?>
                        ...
                        <?php if ($previlize_info->member_change_password == '1'): ?> 
                            <tr>
                                <td width="57%"><font class="inside">Change password</font></td>
                          <td width="43%" style="padding-left:70px">
                                    <?php if ($info->member_change_password == '1'): ?>
<input type="checkbox" name="member_change_password" checked="checked" value="1" />
                                    <?php else: ?>
...
<table cellspacing="1" align="center" cellpadding="2" border="0" id="theBody" style="margin-left:40px; margin-top:10px">
                    <tbody>
                        ...
                        <?php if ($previlize_info->configuration_visibility == '1'): ?> 
                            <tr>
                                ...
                                <td width="33%">
                                    <?php 
									/*if ($info->configuration_visibility == '1'): ?>
                        ...
                        <?php if ($previlize_info->configuration_switching == '1'): ?> 
                            <tr>
                                ...
                                <td width="33%">
									...
									/* if ($info->configuration_switching == '1'): ?>
            ...
            <div style="width:420px; float:left; position:relative;">
                ...
                <table width="331" border="0" align="center" cellpadding="2" cellspacing="1" id="theBody" style="margin-left:40px; margin-top:10px">
<tbody>
                        <tr>
                            <td width="67%"><font class="inside" style="font-weight:bold; color:green">Members
                                </font></td>
                          <td width="33%">                            </td>
          </tr>
                        <?php if ($previlize_info->members_decide == '1'): ?> 
                            <tr>
                                <td width="67%"><font class="inside">-Decide data required for user registration/user profile</font></td>
                  <td width="33%">
                        ...
                        <?php if ($previlize_info->members_add_change == '1'): ?> 
                            <tr>
                                <td width="67%"><font class="inside">-Add/change/block users</font></td>
                  <td width="33%">
                                    <?php 
									/*if ($info->members_add_change == '1'): ?>
                        ...
                        <?php if ($previlize_info->members_c_group == '1'): ?> 
                            <tr>
                                <td width="67%"><font class="inside">Create groups </font></td>
                  <td width="33%">
...
<input type="checkbox" name="members_c_group" checked="checked" value="1" />
                        ...
                        <?php if ($previlize_info->members_add_user == '1'): ?> 
                            <tr>
                                <td width="67%"><font class="inside">Add user to a group</font></td>
                  <td width="33%">
...
<input type="checkbox" name="members_add_user" checked="checked" value="1" />
                        ...
                        <?php if ($previlize_info->members_user_types == '1'): ?> 
                            <tr>
                                <td width="67%"><font class="inside">Create user types (authorization)</font></td>
                  <td width="33%">
                                    <?php
									/* if ($info->members_user_types == '1'): ?>
                        ...
                        <?php if ($previlize_info->members_add_usertype == '1'): ?> 
                            <tr>
                                <td width="67%"><font class="inside">Add user to a usertype</font></td>
                  <td width="33%">
                                    <?php 
									
								/*	if ($info->members_add_usertype == '1'): ?>
