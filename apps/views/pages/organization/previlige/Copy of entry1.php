...
<p class="previlize" style="width:850px; text-align:right; margin:0; padding:20px; height:10px"><a href="<?php echo base_url(); ?>organization/info/view_org_previlize"><span>
<button>View Previlize</button>
</span></a></p>
<?php
