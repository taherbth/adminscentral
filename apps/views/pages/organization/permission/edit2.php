    ...
    <table width="662" cellspacing="1" align="center" cellpadding="2" border="0" id="theBody">
        <tbody>
            <tr>
                ...
                <td width="33%">
                   <?php    $query = $this->db->query("select group_name from org_group where id='" . $info->group_id . "'");
					foreach ($query->result() as $p) {
						$g_name = $p->group_name;
					}
    
	               if(!empty($g_name)):$g_name=$g_name;else:$g_name="";endif;?>
            ...
            <tr>
             ...
             <tr>
                ...
                <td width="33%"><?php echo form_dropdown('message',$message,$info->message,'style=width:150px');?>
                    <span class="markcolor"><?php echo ucwords(form_error('messages')); ?></span> 
                </td>
            </tr>
        </tbody></table>
