<h3 class="content_edit">Archive Article
<?php $mainTab="";
 ...
 endforeach;
if($external_archive_article =='1'):
?>
<div style="width:180px; float:right; padding-top:5px; padding-left:10px; color:green; font-size:18px;">
 <?php
/*  echo form_open("organization/info/view_archive_article_sort"); ?>
 <span style="font-size:10px; color:black"> Sort By </span> <select name="sort_by" class="t">
...
foreach ($query1 as $post_info):
    ...
    <div id="r" style="padding-left:50px; font-size:16px; padding-bottom:7px; margin-bottom:15px;  font-weight:bold">
        <span style="color:#0077D6" >
            ...
            <a href="<?php echo base_url(); ?>organization/presentation/view_mainboard_post_details/<?php echo $post_info->post_id; ?>">
                    ...
                    <span style="color:black; font-size:12px" > <?php echo substr("$post_info->text", 0, 50); ?><span><br />
                            <span style="padding-left:100px; font-size:10px">
                                <span style="color:#689102; font-size:9px" >
                                    <b>Posted By:</b> 
                                    <a  href="<?php echo base_url() ?>organization/info/member_profile/<?php echo $post_info->member_id; ?>" title="">
                                        <?php echo $name; ?>
                                    </a>
  ...
  <?php else:echo "<p style='padding-top:80px; padding-left:20px'><font style='color:red'> Sorry you are not permitted to View Archive Article.</font></p>";endif;?>
