...
endforeach;
$p=$this->db->query("select * from org_profile_previlize where org_id='" . $org_id . "'");
 //echo "<pre>";print_r($p->result());die();
?>
<style>
...
<a href="<?php echo base_url(); ?>organization/presentation/compose_message/<?php echo $org_id;?>">
<img src="<?php echo base_url(); ?>public/images/contact1.png" title="Contact" alt="" border="0" >
</a>
</div>
...
-->                <span style="margin-left:200px; float:right"> 
	 <?php if($mainboard=='1'){?>
     <?php echo form_open("organization/presentation/view_mainboard"); ?>
        <input type="hidden" name="org_id" value="<?php echo $org_id;?>" />
    <input src="<?php echo base_url(); ?>public/images/mainboard1.png" width="40" height="40" style="padding-top:3px" name="submit"  type="image" title="mainboard">
    ...
    <?php }?>
                ...
                <div style="width:900px; ">
                  <?php if($p->num_rows()>0):
                    ...
                    <span style=" padding-left:10px;"><b><font color="green">About Organization</font></b><span>
                    ...
                    <div style="background-color:#E8E8E8; border:1px solid #CCCCCC; margin-top:20px; -moz-border-radius: 8px 8px 8px 8px; width:670px; float: left">
                        ...
                        <div style="width:400px; float:left; position:relative;  margin-top:20px;  ">
                            ...
                            <span style=" padding-left:10px;"><b><font color="green">Profile Info</font></b><span>
                                    ...
                                    <?php else:echo "<font style='color:red'> Sorry you are not permitted to view this  organization Info</font>";endif;?>
