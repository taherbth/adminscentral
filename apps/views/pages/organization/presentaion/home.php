...
foreach ($query->result() as $p_info):
endforeach;
$p = $this->db->query("select * from org_profile_previlize where org_id='" . $this->session->userdata("orgid") . "'");
...
<?php else:echo "<p style='padding-top:80px; padding-left:20px'><font style='color:red'> Sorry you are not permitted to view this  organization Profile</font></p>";
endif; ?>
