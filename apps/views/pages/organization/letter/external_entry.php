<h3 class="content_edit">Org Admin Control Panel Send Letter To External Users</h2>
...
<?php echo form_open("organization/info/added_external_letter"); ?>
...
<div class="infobox" style="width: 916px; margin-bottom: 20px; font-size: 12px; -moz-border-radius: 8px 8px 8px 8px;">
    <div class="infobox_left" style="width: 900px;">
        ...
        <div style="width:800px; float:left; margin-left:120px">
            ...
            <ul>
                <?php $q = $this->db->query("select * from address_list where org_id='" . $this->session->userdata('user_id') . "'"); ?>
