<h3 class="content_edit">Org Admin Control Panel Create Letter Header</h2>
...
<?php echo form_open("organization/letter/added_header"); ?>
            ...
            <tbody>
                <tr>
                    ...
                    <td width="45%">
                        ...
                        <input name="title" style="width:200px; height:25px;" class="" type="text">
                ...
                <tr>
                    <td width="10%"><font class="inside">Header Content </font></td>
                    <td width="45%">
