<h3 class="content_edit">Org Admin Control Panel View Letter Header</h2>
                ...
                foreach ($query->result() as $package_info) {
                    ...
                    <tr bgcolor="<?php echo $color; ?>">
                        ...
                        <td align="center" width="12%" style="padding-top:8px">
                            <a href="<?php echo base_url(); ?>organization/letter/header_edit/<?php echo $package_info->id; ?> " title="Edit the Content"><img src="<?php echo base_url(); ?>public/images/edit.png" border="0" align="absmiddle" alt="<?php echo "#"; ?>"/></a>&nbsp;&nbsp;&nbsp;<a onclick="return confirmSubmit()" href="<?php echo base_url() ?>organization/letter/header_delete/<?php echo $package_info->id; ?>" title="Delete the Content"><img src="<?php echo base_url(); ?>public/images/delete.png" border="0" align="absmiddle" height="20" alt="<?php echo "#"; ?>"/></a>
