...
$query1 = $this->db->query("select * from member_previlige where member_id ='" . $this->session->userdata('id') . "'");
                    ...
                    <tbody>
                        ...
                        <?php if ($previlize_info->mainboard_access_main == '1'): ?>
                            <tr>
                                ...
                                <td width="33%">
                                    <input id="x" type="checkbox" name="mainboard_access_main" value="1" checked="checked" disabled="disabled" />
                                </td>
                            </tr>
                        <?php endif; ?>
                        <?php if ($previlize_info->mainboard_send_proposal == '1'): ?>
                            <tr>
                                ...
                                <td width="33%">
                                    <input id="x" type="checkbox" checked="checked" disabled="disabled" name="mainboard_send_proposal" value="1" />
                                </td>
                            </tr>
                        <?php endif; ?>
                        <?php if ($previlize_info->mainboard_change_article == '1'): ?>
                            <tr>
                                ...
                                <td width="33%">
                                    <input id="x" type="checkbox" name="mainboard_change_article" value="1" checked="checked" disabled="disabled" />
                                </td>
                            </tr>
                        <?php endif; ?>
                        <?php if ($previlize_info->mainboard_send_notification == '1'): ?>
                            <tr>
                                ...
                                <td width="33%">
                                    <input id="x" checked="checked" disabled="disabled" type="checkbox" name="mainboard_send_notification" value="1" />
                                </td>
                            </tr>
                        <?php endif; ?>
                        <?php if ($previlize_info->mainboard_sending_out == '1'): ?>
                            <tr>
                                ...
                                <td width="33%">
                                    <input id="x" checked="checked" disabled="disabled" type="checkbox" name="mainboard_sending_out" value="1" />
                                </td>
                            </tr>
                        <?php endif; ?>
                        <?php if ($previlize_info->mainboard_manually_archive == '1'): ?> 
                            <tr>
                                ...
                                <td width="33%">
                                    <input checked="checked" disabled="disabled"  type="checkbox" name="mainboard_manually_archive" value="1" />
                                </td>
                            </tr>
                        <?php endif; ?>
                    </tbody></table>
                    ...
                    <tbody>
                        ...
                        <?php if ($previlize_info->forum_access == '1'): ?> 
                            <tr>
                                ...
                                <td width="33%">
                                    <input checked="checked" disabled="disabled" type="checkbox" name="forum_access" value="1" />
                                </td>
                            </tr>
                        <?php endif; ?>
                        <?php if ($previlize_info->forum_comments == '1'): ?> 
                            <tr>
                                ...
                                <td width="33%">
                                    <input type="checkbox" name="forum_comments" value="1" checked="checked" disabled="disabled"/>
                                </td>
                            </tr>
                        <?php endif; ?>
                        <?php if ($previlize_info->forum_delete_won_comments == '1'): ?> 
                            <tr>
                                ...
                                <td width="33%">
                                    <input type="checkbox" name="forum_delete_won_comments" value="1" checked="checked" disabled="disabled" />
                                </td>
                            </tr>
                        <?php endif; ?>
                        <?php if ($previlize_info->forum_delete_any_coments == '1'): ?> 
                            <tr>
                                ...
                                <td width="33%">
                                    <input type="checkbox" name="forum_delete_any_coments" value="1" checked="checked" disabled="disabled"/>
                                </td>
                            </tr>
                        <?php endif; ?>
                        <?php if ($previlize_info->forum_manual_comments == '1'): ?> 
                            <tr>
                                ...
                                <td width="33%">
                                    <input type="checkbox" name="forum_manual_comments" value="1" checked="checked" disabled="disabled" />
                                </td>
                            </tr>
                        <?php endif; ?>
                    </tbody></table>
                    ...
                    <tbody>
                        ...
                        <?php if ($previlize_info->member_login_logout == '1'): ?> 
                            <tr>
                                ...
                                <td width="45%" style="padding-left:70px">
                                    <input type="checkbox" name="member_login_logout" value="1" checked="checked" disabled="disabled" />
                                </td>
                            </tr>
                        <?php endif; ?>
                        <?php if ($previlize_info->member_change_profile == '1'): ?> 
                            <tr>
                                ...
                                <td width="33%" style="padding-left:70px">
                                    <input type="checkbox" name="member_change_profile" value="1" checked="checked" disabled="disabled"/>
                                </td>
                            </tr>
                        <?php endif; ?>
                        <?php if ($previlize_info->member_change_password == '1'): ?> 
                            <tr>
                                ...
                                <td width="33%" style="padding-left:70px">
                                    <input type="checkbox" name="member_change_password" value="1" checked="checked" disabled="disabled" />
                                </td>
                            </tr>
                        <?php endif; ?>
                    ...
                    <tbody>
                        ...
                        <?php if ($previlize_info->configuration_view_org == '1'): ?> 
                            <tr>
                                ...
                                <td width="33%">
                                    <input type="checkbox" name="configuration_view_org" value="1" checked="checked" disabled="disabled" />
                                </td>
                            </tr>
                        <?php endif; ?>
                        <?php if ($previlize_info->configuration_change_org == '1'): ?> 
                            <tr>
                                ...
                                <td width="33%">
                                    <input type="checkbox" name="configuration_change_org" value="1"  checked="checked" disabled="disabled"/>
                                </td>
                            </tr>
                        <?php endif; ?>
                        <?php if ($previlize_info->configuration_visibility == '1'): ?> 
                            <tr>
                                ...
                                <td width="33%">
                                    <input type="checkbox" name="configuration_visibility" value="1" checked="checked" disabled="disabled" />
                                </td>
                            </tr>
                        <?php endif; ?>
                        <?php if ($previlize_info->configuration_switching == '1'): ?> 
                            <tr>
                                ...
                                <td width="33%">
                                    <input type="checkbox" name="configuration_switching" value="1" checked="checked" disabled="disabled" />
                                </td>
                            </tr>
                        <?php endif; ?>
                        <?php if ($previlize_info->configuration_create_address == '1'): ?> 
                            <tr>
                                ...
                                <td width="33%">
                                    <input type="checkbox" name="configuration_create_address" value="1" checked="checked" disabled="disabled"/>
                                </td>
                            </tr>
                        <?php endif; ?>
                    ...
                    <tbody>
                        ...
                        <?php if ($previlize_info->communication_send_email == '1'): ?> 
                            <tr>
                                ...
                                <td width="33%">
                                    <input type="checkbox" name="communication_send_email" value="1" checked="checked" disabled="disabled"/>
                                </td>
                            </tr>
                        <?php endif; ?>
                        <?php if ($previlize_info->communication_send_sms == '1'): ?> 
                            <tr>
                                ...
                                <td width="33%">
                                    <input type="checkbox" name="communication_send_sms" value="1"  checked="checked" disabled="disabled"/>
                                </td>
                            </tr>
                        <?php endif; ?>
                        <?php if ($previlize_info->communication_send_letters == '1'): ?> 
                            <tr>
                                ...
                                <td width="33%">
                                    <input type="checkbox" name="communication_send_letters" value="1" checked="checked" disabled="disabled"/>
                                </td>
                            </tr>
                        <?php endif; ?>
                    ...
                    <tbody>
                        ...
                        <?php if ($previlize_info->economics_register == '1'): ?> 
                            <tr>
                                ...
                                <td width="33%">
                                    <input type="checkbox" name="economics_register" value="1" checked="checked" disabled="disabled"/>
                                </td>
                            </tr>
                        <?php endif; ?>
                        <?php if ($previlize_info->economics_send_payment == '1'): ?> 
                            <tr>
                                ...
                                <td width="33%">
                                    <input type="checkbox" name="economics_send_payment" value="1" checked="checked" disabled="disabled" />
                                </td>
                            </tr>
                        <?php endif; ?>
                        <?php if ($previlize_info->economics_check_complete == '1'): ?> 
                            <tr>
                                ...
                                <td width="33%">
                                    <input type="checkbox" name="economics_check_complete" value="1" checked="checked" disabled="disabled"/>
                                </td>
                            </tr>
                        <?php endif; ?>
                        <?php if ($previlize_info->economics_watch_total_income == '1'): ?> 
                            <tr>
                                ...
                                <td width="33%">
                                    <input type="checkbox" name="economics_watch_total_income" value="1"  checked="checked" disabled="disabled"/>
                                </td>
                            </tr>
                        <?php endif; ?>
                        <?php if ($previlize_info->economics_watch_total_cost == '1'): ?> 
                            <tr>
                                ...
                                <td width="33%">
                                    <input type="checkbox" name="economics_watch_total_cost" value="1" checked="checked" disabled="disabled"/>
                                </td>
                            </tr>
                        <?php endif; ?>
                        <?php if ($previlize_info->economics_watch_statistics == '1'): ?> 
                            <tr>
                                ...
                                <td width="33%">
                                    <input type="checkbox" name="economics_watch_statistics" value="1" checked="checked" disabled="disabled"/>
                                </td>
                            </tr>
                        <?php endif; ?>
                    </tbody></table>
                    ...
                    <tbody>
                        ...
                        <?php if ($previlize_info->history_access_articles == '1'): ?> 
                            <tr>
                                ...
                                <td width="33%">
                                    <input type="checkbox" name="history_access_articles" value="1" checked="checked" disabled="disabled"/>
                                </td>
                            </tr>
                        <?php endif; ?>
                        <?php if ($previlize_info->history_access_comments == '1'): ?> 
                            <tr>
                                ...
                                <td width="33%">
                                    <input type="checkbox" name="history_access_comments" value="1" checked="checked" disabled="disabled"/>
                                </td>
                            </tr>
                        <?php endif; ?>
                        <?php if ($previlize_info->history_user_actions == '1'): ?> 
                            <tr>
                                ...
                                <td width="33%">
                                    <input type="checkbox" name="history_user_actions" value="1" checked="checked" disabled="disabled"/>
                                </td>
                            </tr>
                        <?php endif; ?>
                        <?php if ($previlize_info->history_old_letters == '1'): ?> 
                            <tr>
                                ...
                                <td width="33%">
                                    <input type="checkbox" name="history_old_letters" value="1" checked="checked" disabled="disabled"/>
                                </td>
                            </tr>
                        <?php endif; ?>
                        <?php if ($previlize_info->history_old_sms == '1'): ?> 
                            <tr>
                                ...
                                <td width="33%">
                                    <input type="checkbox" name="history_old_sms" value="1" checked="checked" disabled="disabled"/>
                                </td>
                            </tr>
                        <?php endif; ?>
                        <?php if ($previlize_info->history_old_emails == '1'): ?> 
                            <tr>
                                ...
                                <td width="33%">
                                    <input type="checkbox" name="history_old_emails" value="1" checked="checked" disabled="disabled"/>
                                </td>
                            </tr>
                        <?php endif; ?>
                    </tbody></table>
                    ...
                    <tbody>
                        ...
                        <?php if ($previlize_info->members_decide == '1'): ?> 
                            <tr>
                                ...
                                <td width="33%">
                                    <input type="checkbox" name="members_decide" value="1" checked="checked" disabled="disabled"/>
                                </td>
                            </tr>
                        <?php endif; ?>
                        <?php if ($previlize_info->members_add_change == '1'): ?> 
                            <tr>
                                ...
                                <td width="33%">
                                    <input type="checkbox" name="members_add_change" value="1" checked="checked" disabled="disabled"/>
                                </td>
                            </tr>
                        <?php endif; ?>
                        <?php if ($previlize_info->members_c_group == '1'): ?> 
                            <tr>
                                ...
                                <td width="33%">
                                    <input type="checkbox" name="members_c_group" value="1" checked="checked" disabled="disabled"/>
                                </td>
                            </tr>
                        <?php endif; ?>
                        <?php if ($previlize_info->members_add_user == '1'): ?> 
                            <tr>
                                ...
                                <td width="33%">
                                    <input type="checkbox" name="members_add_user" value="1" checked="checked" disabled="disabled"/>
                                </td>
                            </tr>
                        <?php endif; ?>
                        <?php if ($previlize_info->members_user_types == '1'): ?> 
                            <tr>
                                ...
                                <td width="33%">
                                    <input type="checkbox" name="members_user_types" value="1" checked="checked" disabled="disabled"/>
                                </td>
                            </tr>
                        <?php endif; ?>
                        <?php if ($previlize_info->members_add_usertype == '1'): ?> 
                            <tr>
                                ...
                                <td width="33%">
                                    <input type="checkbox" name="members_add_usertype" value="1" checked="checked" disabled="disabled"/>
                                </td>
                            </tr>
                        <?php endif; ?>
                    </tbody></table>
