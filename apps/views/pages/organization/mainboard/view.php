...
<h3 class="content_edit">Orgadmin Control Panel Mainboard</h3>

    <div style="width:180px; float:right; padding-top:5px; padding-left:10px; color:green; font-size:18px;">
        <?php $query = $this->db->query("select * from article_category where org_id='" . $this->session->userdata("user_id") . "'"); ?>
        <?php echo form_open("organization/info/viewed_mainboard"); ?>
...
foreach ($query1 as $post_info):
    ...
    <div id="r" style="padding-left:50px; font-size:16px; padding-bottom:7px; margin-bottom:15px;  font-weight:bold">
        <span style="color:#0077D6" >
            ...
            <a href="<?php echo base_url(); ?>organization/info/view_mainboard_post_detail/<?php echo $post_info->id; ?>">
                    ...
                    <span style="color:black; font-size:12px" > <?php //echo substr("$post_info->text", 0, 50);   ?><span>
                            <span style="padding-left:100px; font-size:10px">
                                <span style="color:#689102; font-size:9px" >
                                    ...
                                    &nbsp;&nbsp;&nbsp; <b>Category:</b> 
                                    <a href="<?php echo base_url(); ?>organization/info/mainboard_viewed/<?php echo $post_info->article_category; ?>">
