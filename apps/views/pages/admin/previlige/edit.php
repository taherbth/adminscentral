<h3 class="content_edit">Admin Control Panel Modify Previlization Seetings  </h2>
...
<tbody>
                        <tr>
                            <td width="60%"><font class="inside" style="font-weight:bold; color:green">Forum</font></td>
                          <td width="40%">                            </td>
          </tr>
                        <tr>
                            <td width="60%"><font class="inside">Access the forum </font></td>
                      <td width="40%">
                        ...
                        <tr>
                            <td width="60%"><font class="inside">Make comments</font></td>
                      <td width="40%">
                        ...
                        <tr>
                           <td width="60%"><font class="inside">Delete ones owns comments</font></td>
                      <td width="40%">
                        ...
                        <tr>
                            <td width="60%"><font class="inside">Delete any comments</font></td>
                      <td width="40%">
                        ...
                        <tr>
                            <td width="60%"><font class="inside">manually archive comments</font></td>
                      <td width="40%">
...
<tbody>
                        <tr>
                            <td width="49%"><font class="inside" style="font-weight:bold; color:green">Members own account
                                </font></td>
                          <td width="51%">                            </td>
          </tr>
                        <tr>
                            <td width="49%"><font class="inside">Log in/Log out </font></td>
                      <td width="51%" style="padding-left:70px">
                        ...
                        <tr>
                            <td width="49%"><font class="inside">Add/change profile info</font></td>
                      <td width="51%" style="padding-left:70px">
                        ...
                        <tr>
                            <td width="49%"><font class="inside">Change password</font></td>
                      <td width="51%" style="padding-left:70px">
                                <?php if ($info->member_change_password == '1'): ?>
                                <?php $m13 = $this->db->query("select * from member_previlige where org_id='" . $org_id . "'and member_change_password=1");
                                    if ($m13->num_rows() > 0): ?>     
...
<table cellspacing="1" align="center" cellpadding="2" border="0" id="theBody" style="margin-left:40px; margin-top:10px">
                    ...
                    <?php $m14 = $this->db->query("select * from member_previlige where org_id='" . $org_id . "'and configuration_view_org=1");
                                    if ($m14->num_rows() > 0): ?>     
                                        <input id="x" type="checkbox" disabled="disabled" name="configuration_view_org"  checked="checked" value="1" />Used
                                        <input id="x" type="hidden"  name="configuration_view_org"  value="1" />
                                    <?php else: ?>
                                        <input id="x" type="checkbox"  name="configuration_view_org"  checked="checked" value="1" />
                                    <?php endif; ?> 
                                <?php else: ?>
                    ...
                    <?php $m141 = $this->db->query("select * from member_previlige where org_id='" . $org_id . "'and configuration_change_org=1");
                                    if ($m141->num_rows() > 0): ?>     
                                        <input id="x" type="checkbox" disabled="disabled" name="configuration_change_org"  checked="checked" value="1" />Used
                                        <input id="x" type="hidden"  name="configuration_change_org"  value="1" />
                                    <?php else: ?>
                    ...
                    <?php $m15 = $this->db->query("select * from member_previlige where org_id='" . $org_id . "'and configuration_create_address=1");
                                    if ($m15->num_rows() > 0): ?>     
                                        <input id="x" type="checkbox" disabled="disabled" name="configuration_create_address"  checked="checked" value="1" />Used
                ...
                <table cellspacing="1" align="center" cellpadding="2" border="0" id="theBody" style="margin-left:40px; margin-top:10px">
                    ...
                    <?php $m16 = $this->db->query("select * from member_previlige where org_id='" . $org_id . "'and external_mainboard=1");
                                    if ($m16->num_rows() > 0): ?>     
                                        <input id="x" type="checkbox" disabled="disabled" name="external_mainboard"  checked="checked" value="1" />Used
                    ...
                    <?php $m17 = $this->db->query("select * from member_previlige where org_id='" . $org_id . "'and external_presentation=1");
                                    if ($m17->num_rows() > 0): ?>     
                                        <input id="x" type="checkbox" disabled="disabled" name="external_presentation"  checked="checked" value="1" />Used
                                        <input id="x" type="hidden"  name="external_presentation"  value="1" />
                                    <?php else: ?>
            ...
            <div style="width:420px; float:left; position:relative;">
                <table cellspacing="1" align="center" cellpadding="2" border="0" id="theBody" style="margin-left:40px">
                    ...
                    <?php $m18 = $this->db->query("select * from member_previlige where org_id='" . $org_id . "'and communication_send_email=1");
                                    if ($m18->num_rows() > 0): ?>     
                                        <input id="x" type="checkbox" disabled="disabled" name="communication_send_email"  checked="checked" value="1" />Used
                    ...
                    <?php $m19 = $this->db->query("select * from member_previlige where org_id='" . $org_id . "'and communication_send_sms=1");
                                    if ($m19->num_rows() > 0): ?>     
                                        <input id="x" type="checkbox" disabled="disabled" name="communication_send_sms"  checked="checked" value="1" />Used
                    ...
                    <?php $m20 = $this->db->query("select * from member_previlige where org_id='" . $org_id . "'and communication_send_letters=1");
                                    if ($m20->num_rows() > 0): ?>     
                                        <input id="x" type="checkbox" disabled="disabled" name="communication_send_letters"  checked="checked" value="1" />Used
                ...
                <table cellspacing="1" align="center" cellpadding="2" border="0" id="theBody" style="margin-left:40px">
                    ...
                    <?php $m21 = $this->db->query("select * from member_previlige where org_id='" . $org_id . "'and economics_register=1");
                                    if ($m21->num_rows() > 0): ?>     
                                        <input id="x" type="checkbox" disabled="disabled" name="economics_register"  checked="checked" value="1" />Used
                    ...
                    <?php $m22 = $this->db->query("select * from member_previlige where org_id='" . $org_id . "'and economics_send_payment=1");
                                    if ($m22->num_rows() > 0): ?>     
                                        <input id="x" type="checkbox" disabled="disabled" name="economics_send_payment"  checked="checked" value="1" />Used
                    ...
                    <?php $m23 = $this->db->query("select * from member_previlige where org_id='" . $org_id . "'and economics_check_complete=1");
                                    if ($m23->num_rows() > 0): ?>     
                                        <input id="x" type="checkbox" disabled="disabled" name="economics_check_complete"  checked="checked" value="1" />Used
                                        <input id="x" type="hidden"  name="economics_check_complete"  value="1" />
                                    <?php else: ?>
                    ...
                    <?php $m24 = $this->db->query("select * from member_previlige where org_id='" . $org_id . "'and economics_watch_total_income=1");
                                    if ($m24->num_rows() > 0): ?>     
                                        <input id="x" type="checkbox" disabled="disabled" name="economics_watch_total_income"  checked="checked" value="1" />Used
                    ...
                    <?php $m25 = $this->db->query("select * from member_previlige where org_id='" . $org_id . "'and economics_watch_total_cost=1");
                                    if ($m25->num_rows() > 0): ?>     
                                        <input id="x" type="checkbox" disabled="disabled" name="economics_watch_total_cost"  checked="checked" value="1" />Used
                    ...
                    <?php $m26 = $this->db->query("select * from member_previlige where org_id='" . $org_id . "'and economics_watch_statistics=1");
                                    if ($m26->num_rows() > 0): ?>     
                                        <input id="x" type="checkbox" disabled="disabled" name="economics_watch_statistics"  checked="checked" value="1" />Used
                ...
                <table cellspacing="1" align="center" cellpadding="2" border="0" id="theBody" style="margin-left:40px; margin-top:10px">
                    ...
                    <?php $m27 = $this->db->query("select * from member_previlige where org_id='" . $org_id . "'and history_access_articles=1");
                                    if ($m27->num_rows() > 0): ?>     
                                        <input id="x" type="checkbox" disabled="disabled" name="history_access_articles"  checked="checked" value="1" />Used
                    ...
                    <?php $m28 = $this->db->query("select * from member_previlige where org_id='" . $org_id . "'and history_access_comments=1");
                                    if ($m28->num_rows() > 0): ?>     
                                        <input id="x" type="checkbox" disabled="disabled" name="history_access_comments"  checked="checked" value="1" />Used
                    ...
                    <?php $m29 = $this->db->query("select * from member_previlige where org_id='" . $org_id . "'and history_user_actions=1");
                                    if ($m29->num_rows() > 0): ?>     
                                        <input id="x" type="checkbox" disabled="disabled" name="history_user_actions"  checked="checked" value="1" />Used
                    ...
                    <?php $m30 = $this->db->query("select * from member_previlige where org_id='" . $org_id . "'and history_old_letters=1");
                                    if ($m30->num_rows() > 0): ?>     
                                        <input id="x" type="checkbox" disabled="disabled" name="history_old_letters"  checked="checked" value="1" />Used
                    ...
                    <?php $m31 = $this->db->query("select * from member_previlige where org_id='" . $org_id . "'and history_old_sms=1");
                                    if ($m31->num_rows() > 0): ?>     
                                        <input id="x" type="checkbox" disabled="disabled" name="history_old_sms"  checked="checked" value="1" />Used
                    ...
                    <?php $m32 = $this->db->query("select * from member_previlige where org_id='" . $org_id . "'and history_old_emails=1");
                                    if ($m32->num_rows() > 0): ?>     
                                        <input id="x" type="checkbox" disabled="disabled" name="history_old_emails"  checked="checked" value="1" />Used
...
<tbody>
                        <tr>
                            <td width="64%"><font class="inside" style="font-weight:bold; color:green">Members
                                </font></td>
                          <td width="36%">                            </td>
          </tr>
                        ...
                        <tr>
                            <td width="64%"><font class="inside">Create groups </font></td>
                      <td width="36%">
                                <?php if ($info->members_c_group == '1'): ?>
                    <?php $m33 = $this->db->query("select * from member_previlige where org_id='" . $org_id . "'and members_c_group=1");
                                    if ($m33->num_rows() > 0): ?>     
                        <input id="x" type="checkbox" disabled="disabled" name="members_c_group"  checked="checked" value="1" />Used
                                        <input id="x" type="hidden"  name="members_c_group"  value="1" />
                                    <?php else: ?>
                        ...
                        <tr>
                            <td width="64%"><font class="inside">Add user to a group</font></td>
                      <td width="36%">
                                <?php if ($info->members_add_user == '1'): ?>
                    <?php $m34 = $this->db->query("select * from member_previlige where org_id='" . $org_id . "'and members_add_user=1");
                                    if ($m34->num_rows() > 0): ?>     
                        <input id="x" type="checkbox" disabled="disabled" name="members_add_user"  checked="checked" value="1" />Used
                                        <input id="x" type="hidden"  name="members_add_user"  value="1" />
                                    <?php else: ?>
                                        <input id="x" type="checkbox"  name="members_add_user"  checked="checked" value="1" />
                                    <?php endif; ?> 
