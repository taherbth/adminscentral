...
$success_url=base_url().'paypal/success'; 
?>
<?php
$attributes = array(
        ...
        <table width="100%" cellpadding="0" cellspacing="0" style="margin-left:5px;">
            ...
            <tbody>
               ...
               <?php if(!empty($booking_time)): ?>
                ...
                <tr><td colspan="3"> <?php echo form_hidden('business',$paypal_email).form_hidden('notify_url',$notify_url).form_hidden('cancel_return',$cancel_url).form_hidden('return',$success_url);  ?>
                </td></tr>
                <tr>
                    <td colspan="3"> <?php echo form_hidden('customer_name',$customer_name).form_hidden('custom',$customer_id).form_hidden('rm','2').form_hidden('cmd','_cart').form_hidden('upload','1').form_hidden('image_url','0').form_hidden('currency_code','GBP');  ?>
                   </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td colspan="3"> 
                        ...
                        <img alt="" style="vertical-align: top;" src="<?php echo base_url(); ?>public/images/button/red-button-left-Large.png">
                        <input type="submit" class="csbtnImageredLarge" value="PAY NOW">
                        <img alt="" style="vertical-align: top;" src="<?php echo base_url(); ?>public/images/button/red-button-right-Large.png">
	                    </div>
