...
{
    $params=array('Konto'=>$konto, 'Passwd'=>$pass, 'till'=>trim($phone_number), 'meddelande'=>$content, 'prio'=>$priority);
    ...
    $result = $client->call("smsBundle", $params);
    return $result['smsBundleResult'];
}
