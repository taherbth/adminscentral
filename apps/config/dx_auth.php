...
$config['DX_user_home_uri'] 			= 'user/backend/';
$config['DX_admin_home_uri'] 			= 'admin/backend/';
$config['DX_superadmin_home_uri'] 		= 'super/backend/';
$config['DX_job_seeker_home_uri'] 		= 'seeker/backend/';
